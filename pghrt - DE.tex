...
\textbf{Die wichtigsten Punkte der Grafik werden wir uns in diesem Leitfaden genauer anschauen. Das eine wichtige Punkt den man sich merken sollte ist der Fakt, dass Veränderungen unterschiedlich schnell passieren.} Diese Tabelle weckt falsche Erwartungen, vermittelt ein ungenaues Bild von der Wirkung der HRT und führt Transmenschen in die Irre, indem sie ein falsches Verständnis von Hormonen erzeugt. Bitte ignoriere sie einfach komplett. Nach diesem kleinen Umweg machen wir jetzt weiter im Programm.
...
(A.d.Ü. Um das Finden von weiterführenden Informationen zu erleichtern verwenden wir die englische Schreibweise, also z.B. Estradiol Enantate anstatt Estradiolenantat. Wir sind uns dieser orthographischen Ungenauigkeit bewusst - allerdings sehen wir hier den Wert der Praktikabilität dieser Anleitung als wichtiger an als den Duden.)
...
\begin{itemize}
  ...
  \item Dein Zugang zu HRT hängt stark von der politischen Stimmung deines Landes ab und dein Trans Diagnose wird sehr wahrscheinlich in der medizinischen Akte vermerkt. 
\end{itemize}
...
\textit{Camille dankt: } Antonia, Lina, Jessica, Anahita, Tessa, Krisho, Cassiopeia und Betty, in einer nur ihr bekannten Reihenfolge, sowie dem französischen Schulsystem, der HU-Berlin und foobar2000.

\textit{Lina dankt: }  Ani, Camille, Cris, Deena, Del, Ellie, Emily, Evelyn, Jan, Kathrine, Kim, Laura, Lilith, Lisa, Mars, Melia, Melina, Melody, Nessa, Nia, Pasha, Paulie, Raven, Rick, Rockie, Sasha, Zoopy und alle die ich vergessen habe in alphabetischer Reihung. Ohne euch hätte ich es nicht geschafft. <3 Ruhe in Frieden, James. Ich vermisse dich jeden Tag.
