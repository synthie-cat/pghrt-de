...
Sobald du dich eingestellt hast, bist du startklar. Injektionen müssen nicht oft gemacht werden (z. B. eine wöchentliche Injektion im Vergleich zu mehreren Pillen täglich), es besteht kein großes Risiko einer falschen Dosierung (im Vergleich zu Gelen), sie können sich nicht mitten im Zyklus von der Haut ablösen (im Vergleich zu Pflastern) und du musst nicht extra zu einem Arzt fahren (im Vergleich zu Pellets).
